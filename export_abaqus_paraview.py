...
CKPT_PATH  = "./checkpoints_abaqus_prevvel_1000data_1000nodes_h128_gfdm_stress"
CKPT_EPOCH = None         # None = latest; set e.g. 500 for a specific epoch
OUTPUT_DIR = "./export_abaqus_paraview_h128_gfdm_stress"
...
NPZ_DIR = "./02_abaqus_npz"  # for elem_conn (exact Abaqus surface topology)
